...
import Hometemp from "../homeapis/Hometemp";
import Homesmoke from "../homeapis/Homesmoke";
import Homeflame from "../homeapis/Homeflame";
import Homelight from "../homeapis/Homelight";
function Home() {
  return (
    <div className="home">
      <Navbar />
        ...
        <CardGroup>
          <Card>
            <div className="card1">
              ...
              <Hometemp/>
              <h2>Temperature</h2>
              <h3>(Ideal Tempereture : 84.2°F)</h3>
            </div>
            <div className="card2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
